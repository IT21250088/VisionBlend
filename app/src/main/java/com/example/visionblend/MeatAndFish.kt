...
class MeatAndFish : AppCompatActivity() {

    private val itemList = listOf(
        Item(R.drawable.beef2, "Beef", 1.99),
        Item(R.drawable.chicken, "Chicken", 0.99),
        Item(R.drawable.fish, "Fish", 1.99),
        Item(R.drawable.pork, "Pork", 1.99),
        Item(R.drawable.prowns, "Prowns", 1.99),
        Item(R.drawable.cuttle_fish, "Cuttle Fish", 1.99),
        Item(R.drawable.fish1, "Fish", 1.99),
        Item(R.drawable.beef, "Beef", 1.99),
    )
